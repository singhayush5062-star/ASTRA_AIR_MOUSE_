...
if __name__ == '__main__':
    ...
    vision_xy_jump_reject = rospy.get_param('~vision_xy_jump_reject', 1.2)
    vision_speed_reject = rospy.get_param('~vision_speed_reject', 4.5)
    vision_z_step_reject = rospy.get_param('~vision_z_step_reject', 0.35)
    rejection_threshold = rospy.get_param('~rejection_threshold', 8)
